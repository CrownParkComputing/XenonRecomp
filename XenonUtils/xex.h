...
// Devkit-signed titles (e.g. After Burner Climax) wrap their session key with
// the all-zero devkit console key instead of the retail key. ReXGlue selects
// it via is_dev_kit_; we try both and accept whichever yields a PE image.
